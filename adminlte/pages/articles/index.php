        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="/adminlte/pages/articles/"><i class="fa fa-angle-double-right"></i> 所有文章</a></li>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($list) && count($list)>0 ){?>
                                    <?php foreach($list as $s){?>
                                        ...
                                        ?>
                                        <tr class="line-<?php echo $s["id"];?>">
                                            <td class="text-center td-<?php echo $s["id"];?>" style="color:<?php echo $color;?>;"><i class="fa fa-fw  <?php echo $class;?> publish-flag" onclick="publish('<?php echo $s["id"];?>','<?php echo $s["publish"];?>')" data="<?php echo $s["id"];?>" publish="<?php echo $s["publish"];?>"></i></td>
                                            <td><?php echo $s["id"];?></td>
                                            <td><?php echo $s["title"];?></td>
                                            <td><?php echo $s["category_name"];?></td>
                                            <td><?php echo date("Y-m-d H:i:s", $s["update_time"]);?></td>
                                            <td class="text-center">
                                                <a href="edit.php?id=<?php echo $s["id"];?>" title="编辑"><i class="fa fa-fw  fa-edit " ></i></a>
                                                <a href="javascript:void(0);" title="删除"><i class="fa fa-fw  fa-trash-o " data="<?php echo $s["id"];?>"></i></a>
                                            </td>
                                        </tr>
                                    <?php }?>
                                <?php }?>
...
<script type="text/javascript">
    $(function() {
        ...
        $(".publish-flag").click(function(){
            var publish_flag = $(this);
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data['status']=="OK"){
                        ...
                        publish_flag.parent("td").css({"color":color});
                    }else{
                        alert("操作失败。");
                    }
                }
