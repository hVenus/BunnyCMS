            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="/adminlte/pages/categories/new.php"><i class="fa fa-angle-double-right"></i> 新建</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        ...
                        <div class='box-body pad'>
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="category_name" placeholder="分类的名称">
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    $(function() {
        $("#btn_save").click(function(){
            ...
            var category_parent = $("#parent_category").val();
            console.log(category_name+"#"+category_parent);
