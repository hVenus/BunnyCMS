            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="/adminlte/pages/categories/"><i class="fa fa-angle-double-right"></i> 所有</a></li>
                        ...
                        <div class="box-body table-responsive">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $s["parent_category"];?></td>
                                    <td class="text-center">
                                        <a href="edit.php?id=<?php echo $s["id"];?>"><i class="fa fa-fw  fa-edit " ></i></a>
                                    </td>
                                </tr>
                                <?php }?>
                                <?php }?>
