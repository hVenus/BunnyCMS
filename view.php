...
<DIV class=wrapper>
    ...
    <div class="MainTable MainDivTable">
        <div class="Main">
            <table width="672" height="100%" border="0" cellspacing="0" cellpadding="0" class="dragTable"  id="list_article" style="clear:both;max-width: 672px;">
                <tr>
                    <td class="head">
                        <h3 class="L"></h3>
                        <span class="TAG"></span>
                ...
                <tr>
                    <td class="middle" style="padding:0 0 0 0;" style="min-height: 400px;">
                        <h3 style="text-align: center"><?php echo $results['title']?></h3>
                        <p style="text-align: center"><?php echo date('Y-m-d', $results['update_time'])?></p>
                        <div class="div-content" style="padding: 40px;"><?php echo $results['content']?></div>
                        <br/><br/><br/><br/><br/>
                    </td>
                </tr>
                <tr>
